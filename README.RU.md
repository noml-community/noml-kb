...
Исследование операций и Интеллект Принятия Решений (ИОИПР) / NoML (Not Only ML) — Профессиональное сообщество, посвящённое анализу данных, исследованию операций и другим областям прикладной математики.
